  ...
  <div class="Consultingdetail">
    ...
    <div class="mycontainer" style="background: none">
      <div class="zxbox">
        ...
        <div class="zxright">
          <div>
            <div class="serachbox lightgreybor">
              <input type="text">
            </div>
            <div class="reds tosearch">搜咨询</div>
          </div>
          <div class="lightgreybor">
            <div class="gh_info_list tjinfo m_t10">
              <ul>
                <li v-for="(val,index) in news" :key="index">
                  <a @click="godetail(val.url)">{{val.tittle}}</a>
                </li>
              </ul>
            </div>
          </div>

          <div class="lightgreybor tjproduct">
            <div>
                            <span class="pic">
                                <img src="" alt="">
                            </span>
              <span class="name">夏季衣服大合集</span>
            </div>
            <div>
                            <span class="pic">
                                <img src="" alt="">
          ...
          <div class="cq_ask">
            <div class="tit_div2">热门阅读排行</div>
            <div class="rig_infodiv">
              <div class="h_ph">
                <ul>
                  <li v-for="(val,index) in hotnews" :key="index">
                    <a @click="godetail(val)" :title="val.tittle">
                      <span class="num" :class="{num_on:index<=2}">{{index+1}}</span>{{val.tittle}}</a>
                  </li>
...
<script>
  export default {
    data() {
      return {
        news: [
          {
            id:'',
            tittle: '拼机遇·抖精彩-苏宁拼购招商会&amp;抖音运营公开课圆满落',
            url: ''
          },{
            id:'',
            tittle: '苏宁拼购朱永国：苏宁拼购及当下最新的招商政策',
            url: ''
          },{
            id:'',
            tittle: '苏宁拼购李先知：苏宁拼购双十一营销玩法',
            url: ''
          },{
            id:'',
            tittle: '巨量引擎陶方俊：【引流电商】“流量蓝海”品效结合打造电商爆款',
            url: ''
          },{
            id:'',
            tittle: '巨量引擎贺晨阳：抖音短视频电商行业内容运营方法论',
            url: ''
          },{
            id:'',
            tittle: '91家纺网志愿者贴心服务，助力五山森林音乐节！',
            url: ''
          }
        ],
        status: '全部',
        hotnews: [
          { id:'',tittle: '宝宝冬天盖什么被子好？盖多少合适？一定要看完！', url: ''},
          { id:'',tittle: '这个冬天，床品保暖的最佳组合是......', url: ''},
          { id:'',tittle: '宝宝冬天盖什么被子好？盖多少合适？一定要看完！', url: ''},
          { id:'',tittle: '宝宝冬天盖什么被子好？盖多少合适？一定要看完！', url: ''},
          { id:'',tittle: '这个冬天，床品保暖的最佳组合是......', url: ''},
          { id:'',tittle: '恬静柔软，温暖一生——j-3', url: ''},
          { id:'',tittle: '这个冬天，床品保暖的最佳组合是......', url: ''},
          { id:'',tittle: '恬静柔软，温暖一生——j-3', url: ''},
          { id:'',tittle: '恬静柔软，温暖一生——j-3', url: ''},
          { id:'',tittle: '恬静柔软，温暖一生——j-3', url: ''},
    ...
    methods: {
      ...
      godetail(val){
        let airticleid=val.id
        let routeData = this.$router.resolve({name: 'Consultingdetail',query:airticleid});
